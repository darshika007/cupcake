...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right " style="margin-top: 10px;">
                    ...
                    <li>
                        <a href="index.phpl#about">About Us</a>
                    </li>
                    <li>
    ...
    <section id="venue_gallery" style="margin-top: 5%; margin-bottom: 10%;">
        <div class="container" >
            ...
            <?php
            $count=0;
                    $sql="SELECT * FROM gallery WHERE cname='".$cnameid."'";
                    ...
                    <div class="col-md-10 col-md-push-2" style="margin-bottom: 5%;">
                         <?php echo '<h1 style="font-family:Germania One, cursive; color: #000; margin-left: 16%; font-size: 50px;">'.$row['cname'].'</h1>'; ?>
                        </div>
                    <?php } 
                    }?>
                        <?php
                ...
                <div class="col-md-4"  style="margin-top: 20px;">
                    <img src="<?php echo '../admin/Pictures/'. $row['file1']; ?>" height="370px;" width="320px;" style="box-shadow: 3px 3px #4d4b4b; ">
                </div>
                    <?php } ?>
            </div>
            </div>
