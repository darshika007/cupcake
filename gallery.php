...
<body>
    ...
    <section id="bp_banner" style="background: #fff; overflow-x: hidden">
        ...
        <div class="hero-text">
            <h1 style="color: #fff; text-align: center; z-index: 1; font-size: 90px;">Gallery</h1>
        </div>
    </section>
    <!--End Banner-->

    <section id="venue_gallery" style="margin-top: 10%; margin-bottom: 10%;">
        <div class="container">
            <div class="row">
                <?php
                ...
                <div class="col-md-4 ">
                    <div class="content">
                    <a href="venue_gallery.php?cnameid=<?php echo $row['cname']; ?>"><div class="content-overlay"></div>
